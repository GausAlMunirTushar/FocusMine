    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <section className="py-8 sm:py-16 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Your complete productivity toolkit with Pomodoro timer, task management, note-taking, daily planning, and
            learning tracking.
          </p>
      ...
      <section className="py-8 px-4">
        <div className="container mx-auto max-w-2xl">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">Try the Pomodoro Timer</h2>
            <p className="text-muted-foreground">
              Experience our focus timer right here. Start a 25-minute session and boost your productivity.
            </p>
          </div>
      ...
      <section className="py-8 sm:py-16 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">Complete Productivity Suite</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Everything you need to stay focused, organized, and productive in one integrated platform.
            </p>
          </div>
              ...
              <Link key={index} href={tool.href}>
                ...
                >
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardTitle className="text-lg sm:text-xl mb-2">{tool.name}</CardTitle>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-6 sm:gap-8 text-center max-w-6xl mx-auto">
            <div className="p-6 rounded-lg bg-background/50 backdrop-blur border shadow-sm">
              <div className="text-3xl sm:text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">8</div>
              <p className="text-muted-foreground">Productivity Tools</p>
            </div>
            <div className="p-6 rounded-lg bg-background/50 backdrop-blur border shadow-sm">
              <div className="text-3xl sm:text-4xl font-bold text-green-600 dark:text-green-400 mb-2">25:00</div>
              <p className="text-muted-foreground">Perfect Focus Duration</p>
            </div>
            <div className="p-6 rounded-lg bg-background/50 backdrop-blur border shadow-sm">
              <div className="text-3xl sm:text-4xl font-bold text-purple-600 dark:text-purple-400 mb-2">2+</div>
            ...
            <div className="p-6 rounded-lg bg-background/50 backdrop-blur border shadow-sm">
              ...
              <p className="text-muted-foreground">Free & Open Source</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-20 px-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Ready to supercharge your productivity?</h2>
          <p className="text-lg sm:text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Join thousands of developers and knowledge workers who use FocusNest's complete productivity suite to stay
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 items-center">
            <div className="text-center sm:text-left">
              ...
              <p className="text-sm text-muted-foreground">Complete productivity suite for focused work.</p>
            </div>

            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-2">Created by</p>
              <p className="font-semibold">Gaus Al Munir Tushar</p>
              <p className="text-xs text-muted-foreground">Full Stack Developer</p>
            </div>

            <div className="flex justify-center lg:justify-end gap-2">
              <a
                href="https://github.com/gausaltushar"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/in/gausaltushar"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-foreground transition-colors p-2 rounded-lg hover:bg-background"
              >
              ...
              <a
                href="https://twitter.com/gausaltushar"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-foreground transition-colors p-2 rounded-lg hover:bg-background"
              >
          ...
          <div className="border-t mt-6 sm:mt-8 pt-4 sm:pt-6 text-center">
            <p className="text-xs text-muted-foreground">
              &copy; 2024 FocusNest. Made with ❤️ by Gaus Al Munir Tushar. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
