          ...
          <CardContent className="prose prose-gray dark:prose-invert max-w-none space-y-6">
            <section>
              ...
              <p className="text-muted-foreground">
                By accessing and using FocusNest, you accept and agree to be bound by the terms and provision of this
                agreement.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Permission is granted to temporarily use FocusNest for personal, non-commercial transitory viewing only.
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                at all times. You are responsible for safeguarding the password.
              </p>
            </section>
